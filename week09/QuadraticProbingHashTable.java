...
public class QuadraticProbingHashTable<AnyType>
{
    ...
    public boolean insert( AnyType x, Value value )
    {
        ...
        if( isActive( currentPos ) ) // x already exists in the table. overwrite value 
            return array[currentPos].entry.value = value;  

        if( array[ currentPos ] == null )
            ++occupied;
        array[ currentPos ] = new HashEntry<>( x, value);
        theSize++;
        
            // Rehash; see Section 5.5
        if( occupied > array.length / 2 ) // load factor > 0.5
            rehash( );
    ...
    private void rehash( )
    {
        ...
        theSize = 0;
            ...
            // reinsert all active items into the new table 
    ...
    {
        public AnyType  element;   // the key 
